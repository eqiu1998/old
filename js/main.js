(function() {
  ...
  // Typed Js
  $(".element").typed({
    strings: ["I'm a Software Engineer", "I'm a Problem Solver", "I'm a Photographer", "I'm a Traveller"],
    typeSpeed: 1,
    backSpeed: 1,
    backDelay: 1000,
    loop: true
  ...
  $(".sub-title").typed({
    strings: ["Software Engineer", "Problem Solver", "Photographer", "Traveller"],
    typeSpeed: 1,
    backSpeed: 1,
    backDelay: 1400,
    loop: true
